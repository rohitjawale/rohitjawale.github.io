...
! function(t) {
    ...
    window.tram = function(t) {
        ...
        if (z.transition) {
            var D = z.timing.dom;
            if (C.style[D] = f["ease-in-back"][0], !C.style[D])
        ...
        var M = e.frame = function() {
            ...
            q = l($, function(t, e) {
                ...
                t.init = function() {
                    e.init.apply(this, arguments), this.current || (this.current = {}, K.perspective && B.perspective && (this.current.perspective = B.perspective, G(this.el, this.name, this.style(this.current)), this.redraw()))
                }, t.set = function(t) {
        ...
        e.fallback = function(t) {
            if (!z.transition) return B.fallback = !0;
            B.agentTests.push("(" + t + ")");
        ...
        z.transform && (Y.transform = [q], K = {
            ...
            skewX: [k],
            skewY: [k]
        }), z.transform && z.backface && (K.z = [x, "translateZ"], K.rotateZ = [k], K.scaleZ = [g], K.perspective = [y]);
        var Q = /ms/,
            J = /s|\./;
        return t.tram = e
    }(window.jQuery)
                ...
                ! function(e, n) {
                    ...
                    if (w) l.on("click", function(t) {
                        ...
                        v.on("click", function() {
                            ...
                            (i = r.target && r.target.files && r.target.files[0]) && (o.toggle(!1), c.toggle(!1), a.toggle(!0), m.text(i.name), C() || k(n), n.fileUploads[e].uploading = !0, function(e, n) {
                                var i = {
                                    name: e.name,
                                    size: e.size
                                };
                    ...
                    function E(t) {
                        var i = t.responseJSON && t.responseJSON.msg,
                            r = y;
                        "string" == typeof i && 0 === i.indexOf("InvalidFileTypeError") ? r = b : "string" == typeof i && 0 === i.indexOf("MaxFileSizeError") && (r = g), h.text(r), l.removeAttr("data-value"), l.val(""), a.toggle(!1), o.toggle(!0), c.toggle(!0), n.fileUploads[e].uploading = !1, C() || x(n)
                    }
                    function O(e, n) {
                        if (e) return E(e);
                        var r = n.fileName,
                    ...
                    function T(t) {
                        if (t) return E(t);
                        a.toggle(!1), s.css("display", "inline-block"), n.fileUploads[e].uploading = !1, C() || x(n)
                    }
                    function C() {
    ...
    i.define("navbar", t.exports = function(t, e) {
        ...
        function T(n, i) {
            ...
            c && "/" === c.attr("href") && null == c.attr("aria-label") && c.attr("aria-label", "home"), a.button.attr("style", "-webkit-user-select: text;"), null == a.button.attr("aria-label") && a.button.attr("aria-label", "menu"), a.button.attr("role", "button"), a.button.attr("tabindex", "0"), a.button.attr("aria-controls", a.overlayContainerId), a.button.attr("aria-haspopup", "menu"), a.button.attr("aria-expanded", "false"), a.el.off(m), a.button.off(m), a.menu.off(m), S(a), s ? (A(a), a.el.on("setting" + m, function(t) {
                return function(n, i) {
                    i = i || {};
                    var r = f.width();
                    S(t), !0 === i.open && F(t, !0), !1 === i.open && q(t, !0), t.open && e.defer(function() {
                        r !== f.width() && z(t)
                    })
                }
            }(a))) : (! function(e) {
        ...
        function q(t, e) {
            ...
            function u() {
                t.menu.height(""), l(t.menu).set({
                    x: 0,
                    y: 0
                }), t.menu.each($), t.links.removeClass(x), t.dropdowns.removeClass(g), t.dropdownToggle.removeClass(b), t.dropdownList.removeClass(y), t.overlay && t.overlay.children().length && (_.length ? t.menu.insertAfter(_) : t.menu.prependTo(t.parent), t.overlay.attr("style", "").hide()), t.el.triggerHandler("w-close"), t.button.attr("aria-expanded", "false")
            }
        }
        return c
    })
